...
``1.1, master``
    ...
    $ django-admin startproject --template=https://github.com/AMHZR/django-project-skeleton/archive/1.1.zip [projectname]


``1.0``
    suitable for Django version: **1.7.4**::

    $ django-admin startproject --template=https://github.com/AMHZR/django-project-skeleton/archive/1.0.zip [projectname]
